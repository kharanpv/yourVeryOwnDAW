...
- [ ] **Audio Device Initialization:** Code to open the computer's soundcard using SDL2.
- [ ] **The Audio Callback Function:** The high-priority loop that constantly fills the soundcard's buffers with audio data exactly when requested.
- [ ] **Buffer Management:** Ensuring the flow of audio data never starves or overflows.
...
- [ ] **Sine Wave Generator (MVP):** A basic math function outputting a simple waveform to prove the engine works.
