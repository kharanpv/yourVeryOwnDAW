...
// close the SDL audio device if it was opened.
...
bool AudioDevice::initialize(IAudioSource* source) {
    ...
    // Default settings for a DAW-like playback: 44.1kHz, 32-bit float, stereo.
    desiredSpec.freq = 44100;          
    desiredSpec.format = AUDIO_F32SYS;
    desiredSpec.channels = 2;          // Stereo
    desiredSpec.samples = 512;         // Size of the audio buffer in samples
    desiredSpec.callback = audioCallback;
    desiredSpec.userdata = this;       // Pass `this` so th
